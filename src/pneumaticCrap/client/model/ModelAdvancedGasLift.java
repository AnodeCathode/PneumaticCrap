package pneumaticCrap.client.model;
...
public class ModelAdvancedGasLift extends ModelBase implements IBaseModel{
    //fields
    ...
    public void renderStatic(float size, TileEntity te){
        ...
        Shape2.render(size);
        Shape3.render(size);
        FMLClientHandler.instance().getClient().getTextureManager().bindTexture(Textures.MODEL_ADVANCED_PRESSURE_TUBE);
        if(te != null) {
            boolean[] sidesConnected = ((TileEntityAdvancedGasLift)te).sidesConnected;
