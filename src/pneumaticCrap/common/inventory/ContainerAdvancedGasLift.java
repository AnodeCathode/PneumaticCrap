package pneumaticCrap.common.inventory;
...
public class ContainerAdvancedGasLift extends ContainerPneumaticBase<pneumaticCrap.common.tileentity.TileEntityAdvancedGasLift>{

    public ContainerAdvancedGasLift(InventoryPlayer inventoryPlayer, pneumaticCrap.common.tileentity.TileEntityAdvancedGasLift te){
        super(te);
        ...
        addSlotToContainer(new Slot(te, 4, 55, 48){
            ...
            public boolean isItemValid(ItemStack stack){
                return stack != null && stack.isItemEqual(new ItemStack(Blockss.advancedPressureTube));
            }
        });
