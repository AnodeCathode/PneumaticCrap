...
public class TileEntityAdvancedGasLift extends TileEntityPneumaticBase implements IMinWorkingPressure, IRedstoneControlled,
    ...
    public TileEntityAdvancedGasLift(){
        super(25, 30, 6000);
                    ...
                    if(mode == 2) {
                        if(currentDepth > 0) {
                            ...
                            if(isPipe(xCoord, yCoord - currentDepth, zCoord)) {
                                if(IOHelper.insert(this, new ItemStack(pneumaticCraft.common.block.Blockss.advancedPressureTube), 0, false) == null) {
                            ...
                            if(yCoord - currentDepth >= 0 && !isUnbreakable(xCoord, yCoord - currentDepth - 1, zCoord)) {
                                ...
                                if(!isPipe(xCoord, yCoord - currentDepth, zCoord)) {
                                    if(inventory[4] != null) {
                                        decrStackSize(4, 1);
                                        worldObj.func_147480_a(xCoord, yCoord - currentDepth, zCoord, false);
                                        worldObj.setBlock(xCoord, yCoord - currentDepth, zCoord, pneumaticCraft.common.block.Blockss.advancedPressureTube);
                                        addAir(-100, ForgeDirection.UNKNOWN);
                                    } else {
                                        status = 0;
                                        currentDepth--;
    ...
    private boolean isPipe(int x, int y, int z){
        return worldObj.getBlock(x, y, z) == pneumaticCraft.common.block.Blockss.advancedPressureTube;
    }
    ...
    public String getInventoryName(){
        return Blockss.advancedGasLift.getUnlocalizedName();
    }
    ...
    public boolean isItemValidForSlot(int par1, ItemStack stack){
        return stack != null && (par1 < 4 && stack.getItem() == Itemss.machineUpgrade || par1 == 4 && stack.isItemEqual(new ItemStack(pneumaticCraft.common.block.Blockss.advancedPressureTube)));
    }
